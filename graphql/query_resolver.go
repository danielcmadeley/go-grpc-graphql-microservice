...
func (r *queryResolver) Accounts(ctx context.Context, pagination *PaginatedInput, id *string) ([]*Account, error) {
...
func (r *queryResolver) Products(ctx context.Context, pagination *PaginatedInput, query *string, id *string) ([]*Product, error) {
	ctx, cancel := context.WithTimeout(ctx, 3*time.Second)
	defer cancel()
...
func (p PaginatedInput) bounds() (uint64, uint64) {
	skipValue := uint64(0)
